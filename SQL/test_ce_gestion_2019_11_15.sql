...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2019 at 10:59 PM
...
(1, 1, 2, 'PERSONA ID: 20', 'PERSONA', '2019-11-13 01:50:30'),
(3, 1, 2, 'PERSONA ID: 22', 'PERSONA', '2019-11-15 03:31:01'),
(4, 1, 2, 'PERSONA ID: 23', 'PERSONA', '2019-11-15 19:20:40'),
(5, 1, 2, 'PERSONA ID: 24', 'PERSONA', '2019-11-15 19:26:16');
...
(4, 'Refrigeración', 1, 'Curso dedicado a la reparación de equipos', 1);
...
(13, 5, 1, NULL, '2019-11-15', '2019-11-15 12:32:20', NULL, '60000.00', '60000.00', '0.00', '60000.00', 1),
(14, 5, 1, NULL, '2019-11-15', '2019-11-15 12:56:01', NULL, '60000.00', '65000.00', '0.00', '65000.00', 1),
(15, 5, 1, NULL, '2019-11-15', '2019-11-15 13:31:27', NULL, '60000.00', '60000.00', '0.00', '60000.00', 1),
(16, 5, 1, NULL, '2019-11-15', '2019-11-15 13:58:06', NULL, '60000.00', '60000.00', '0.00', '60000.00', 1),
(17, 7, 1, NULL, '2019-11-15', '2019-11-15 16:17:32', NULL, '60000.00', '60000.00', '0.00', '60000.00', 1);
...
(1, '', 1, 1, 1, 1, 4, 15, '60000.00', 1, 'Sin Descripción', 8),
(3, '', 2, 4, 1, 1, 4, 5, '60000.00', 1, 'Sin Descripción', 1),
(7, '', 3, 9, 1, 1, 3, 5, '65000.00', 1, 'Sin Descripción', 2),
...
(15, '', 3, 10, 1, 1, 4, 5, '60000.00', 1, 'Corte y costura', 1),
(16, 'Inf-000001', 1, 9, 1, 1, 4, 5, '60000.00', 1, 'Más programación', 2),
(17, 'Ref-000001', 4, 11, 2, 1, 4, 15, '60000.00', 1, 'Curso dictado en sede de IF', 0);
...
(1, 15, 1, 1, 1, 'tra-000028', '463467894321', '55000.00', '2019-10-24', '2019-10-24 19:28:11', 2),
...
(10, 16, 1, 1, 5, 'tra-000034', '0102428459654323', '60000.00', '2019-11-15', '2019-11-15 12:24:42', 2),
(11, NULL, 3, 1, 10, 'tra-000035', '1903', '60000.00', '2019-11-15', '2019-11-15 15:34:38', 1),
(12, NULL, 3, 1, 10, 'tra-000036', '6287', '60000.00', '2019-11-15', '2019-11-15 15:43:11', 1),
(13, 17, 3, 1, 1, 'tra-000037', '254565458789', '60000.00', '2019-11-15', '2019-11-15 16:16:32', 2);
...
(10, 24, NULL, 1, '2019-11-15 15:28:40');
...
(14, 8477818, 'Felix', 'Blackman', '1', '1965-05-27', '04248113920', 'El Tigre, detrás de La Cascada', 0, '2019-11-06 17:11:32'),
...
(21, 8477827, 'Gregorio', 'Velásquez', '1', '1964-06-27', '02834002095', 'El Tigre, Chaguaramos', 1, '2019-11-14 23:15:58'),
(22, 8466825, 'Carlos', 'Contreras', '1', '1964-10-06', '04243254403', 'El Tigre, carretera negra', 1, '2019-11-14 23:31:00'),
(23, 10939925, 'Freddy', 'Miranda', '1', '0000-00-00', '', '', 1, '2019-11-15 15:20:39'),
(24, 27380945, 'Samuel Andrés', 'Requena Abache', '1', '1999-11-21', '04248812413', 'Urb. Virgen del Valle c/ Santa Rosa P130', 1, '2019-11-15 15:26:16');
...
INSERT INTO `titular` (`id_cliente`, `fk_id_persona_1`, `serial_cliente`, `estado_cliente`, `fecha_registro_cliente`) VALUES
...
(9, 20, NULL, 1, '2019-11-15 10:00:41'),
(10, 24, NULL, 1, '2019-11-15 15:27:10');
...
(2, 'Jesús', 'Blanco', 'jesusb@cecal.com', 'jesus-1325', '98ce34038035debf9af5d5482829aeddfb543f7e', 2, 1, '2019-11-14 20:45:32', '2019-11-14 22:14:19'),
(3, 'José', 'José', 'josejose@cecal.com', 'jose-jose', '98ce34038035debf9af5d5482829aeddfb543f7e', 1, 1, '2019-11-14 22:09:53', '2019-11-14 22:09:53'),
(4, 'Carmen', 'San Diego', 'carmen@cecal.com', 'Carmen-sandiego', '98ce34038035debf9af5d5482829aeddfb543f7e', 2, 1, '2019-11-14 22:31:18', '2019-11-14 22:31:18');
...
--
ALTER TABLE `accion`
  MODIFY `id_accion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID de la tabla', AUTO_INCREMENT=6;
...
--
ALTER TABLE `facilitador`
  MODIFY `id_facilitador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `inscripcion`
--
ALTER TABLE `inscripcion`
  MODIFY `id_inscripcion` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID de la entidad, autogenerado', AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `inscripcion_curso`
--
ALTER TABLE `inscripcion_curso`
  MODIFY `id_inscripcion_curso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `instancia`
--
ALTER TABLE `instancia`
  MODIFY `id_instancia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `persona`
  MODIFY `persona_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `pago_de_inscripcion`
  ADD CONSTRAINT `FK_PAGO_INSCRIPCION_1` FOREIGN KEY (`fk_id_cliente`) REFERENCES `titular` (`id_cliente`),
...
--
ALTER TABLE `titular`
  ADD CONSTRAINT `titular_ibfk_1` FOREIGN KEY (`fk_id_persona_1`) REFERENCES `persona` (`persona_id`);
