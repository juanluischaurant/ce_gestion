                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>gestion/facilitador/store" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombre_facilitador" name="nombre_facilitador" value="<?php echo isset($persona) ? $persona->nombres_persona : ''; ?>">
                            </div>

                            <div class="form-group">
                                <label for="apellido_facilitador">Apellidos:</label>
                                <input type="text" class="form-control" id="apellido_facilitador" name="apellido_facilitador" value="<?php echo isset($persona) ? $persona->apellidos_persona : ''; ?>">
                            </div>
