                        ...
                        <form id="editar_persona" action="<?php echo base_url();?>gestion/persona/update" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control <?php echo !empty(form_error('direccion-persona'))? 'has-error' : '';?>" id="direccion-persona" name="direccion-persona" rows="1" placeholder="Ej: Sector Central, calle 10 cruce con avenida 4"><?php echo $persona->direccion; ?></textarea>
